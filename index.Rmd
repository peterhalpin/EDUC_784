...
There are few goals of moving from "textbook + slides + exercises" to an ebook. 
...
* Most importantly, having a course text that is tightly aligned with the course content means that I can be more liberal in assigning readings as homework *before class*, so we can spend less time lecturing and more time discussing any questions you have about the readings, going through the examples in R together, and working on assignments.  
* As a bonus, this book is another example cool things you can do with R. It's written in R (https://bookdown.org) -- that is crazy, right??
...
2. We will go through the assigned readings again in class together (as slide show), this time focusing any questions you have and on doing R exercizes. 
