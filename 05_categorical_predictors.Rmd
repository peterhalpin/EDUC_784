...
* Please take a moment and write down how these two numbers in the R output related to the Figure. In particular, what is $\bar Y_0$ equal to, what is $\bar Y_1$ equal to, and what is their difference equal to?
...
* If you have any questions about the relation between these two sets of output (below), please note them now and be prepared ask them in class.
