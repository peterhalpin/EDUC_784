...
normally distributed and its expected value is equal to the hypothesized
value of the parameter, then $t$ has a "central" $t$-distribution.)
...
important to use the $t$-distribution rather than the normal distribution.
