...
Here is hint for the following question: In the Yerkes-Dodson law, when the $X$ variable is centered, the regression coefficient for the linear term is not statistically significant. 
...
We have reasoned that the relationship between wages and education might change as a function whether or not people have a post-secondary education. We also noted that this sounds a lot like an interaction (because it is!), which is the basic approach we can use to create piecewise models. 
...
This short section will be added before class on March 31 and the content will be covered during class time
...
And finally, the piecewise model from Section \@ref(piecewise-10)
