...
This example is a bit unusual in the sense that the HC standard errors were actually a bit smaller than the regular OLS standard errors (see the output in Section \@ref(piecewise-4)) -- more often the opposite is true. Nonetheless, you should have no problems interpreting the output above.  
