...
The upshot of all this is that the predictors will be less redundant with the interaction term -- i.e., centering reduces multicollinearity between the "main effects" of the predictors and their interaction. 
