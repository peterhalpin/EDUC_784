...
We can also examine the statistical significance of the simple trends using this type of approach. But, since those trends aren't very meaningful in the context of this example, we will save this for the Exercises in Section \@ref(exercises-6). Note the computations going on "under the hood" for testing marginal means and simple trends are actually pretty complicated. You can read more details here: https://cran.r-project.org/web/packages/emmeans/vignettes/basics.html 
