...
So, taking the log of $100$ gives us $4.60517$, and taking the exponent of $4.60517$ gets us back to the original input, $100$. In general, $e^{\log(x)} = x$. So, exponentiation (i.e., raising something to a power) undoes the logarithm. This undoing is called "inversion" in mathematic.   
