...
$$ \sum_i X_i. $$ If you write it this way, the reader will assume that you mean to sum over all the values of $X$ in a sample.
...
$$ t = \frac{\text{sample value} - \text{null-hypothesized value}}{\text{standard error}} $$ For a specific example, see section \@ref(inference-for-slope-2).
